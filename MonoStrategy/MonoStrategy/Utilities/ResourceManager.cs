...
namespace MonoStrategy.Utility
{
    public class ResourceManager
    {
        ...
        public ResourceManager(ContentManager content, GraphicsDevice graphics) 
        {
            ...
            //Load effects
            string effectDirectory = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName + "\\Content\\Effects\\";
            Console.WriteLine(effectDirectory);
            BinaryReader Reader = new BinaryReader(File.Open(effectDirectory + "RegularEffect.mgfxo", FileMode.Open));
