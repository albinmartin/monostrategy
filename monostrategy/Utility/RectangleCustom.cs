...
namespace monostrategy.Utility
{
    ...
    public struct RectangleCustom
    {
        ...
        public RectangleCustom(Vector2 position, Vector2 bounds)
        {
            x = position.X;
            y = position.Y;
            width = bounds.X;
        ...
        public RectangleCustom(float x, float y, float width, float height)
        {
            this.x = x;
            this.y = y;
            this.width = width;
